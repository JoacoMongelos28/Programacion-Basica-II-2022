...
public class Autobus extends Vehiculos {
	...
	private final Integer CANTIDAD_MAXIMA_DE_PASAJEROS = 20;
	private Double CantidadDeKilometrosRecorridos;
	private Chofer choferActual;
	private List<Pasajero> pasajeros;
	private List<Chofer> choferes;
	private Integer cantidadDePasajeros;
	private final Integer CANTIDAD_MAXIMA_DE_CHOFERES;

	public Autobus(Double cantidadDeKilometrosRecorridos) {
